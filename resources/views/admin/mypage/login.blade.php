...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/admin/mypage/login.css') }}">
...
<article id="main-content">
    ...
    <form action="{{ route('admin.mypage.login.post') }}" method="POST">
        @csrf
        <section class="user-info-section-wrap">
            <div class="user-info-section">
                ...
                <button name="login" class="login-button">ログイン</button>
            </div>
        </section>
    </form>
