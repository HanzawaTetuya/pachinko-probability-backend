...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/admin/mypage/password_edit.css') }}">
    ...
    <section class="user-info-section-wrap">
        <div class="user-info-section">
            <div class="container-header">
                <p>アカウントに関連付けられているパスワードを変更する場合は、下で変更することができます。完了したら［保存］ボタンをクリックしてください。</p>
            </div>

            <form action="{{ route('admin.mypage.update', ['type' => 'password']) }}" method="POST">
                @csrf
                ...
                <div class="password-confirm-container">
                    ...
                    <div class="password-input-wrapper">
                        ...
                        <span class="toggle-visibility">
                            <img src="{{ asset('img/see.svg') }}" alt="パスワード表示切替" id="toggle-password-confirm-visibility">
                        </span>
                    </div>
                </div>
