...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/admin/sales/month.css') }}">
...
<article id="main-content">
    <h2 class="section-title">{{ $formattedMonth }} の売り上げ</h2>
                ...
                <tr>
                    <td class="detail-link">
                        <form action="{{ route('show.sales.detail') }}" method="POST">
                            ...
                            <input type="hidden" name="previous" value="monthly">
