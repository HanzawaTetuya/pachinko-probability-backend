            ...
            <form action="{{ route('admin.user.update', ['id' => $user->id]) }}" method="POST">
                ...
                <div class="user-info-group-wrap switch-group">
                    <div class="toggle_button">
                        <label for="public-setting">ステータス</label>
                        <input id="toggle" class="toggle_input" type="checkbox" name="status" value="active" {{ $user->status === 'active' ? 'checked' : '' }}>
                        <label for="toggle" class="toggle_label"></label>
                    </div>
                </div>

                <!-- 確認ボタン -->
                <div class="user-info-group-wrap user-btn-group">
                    <div class="user-info-group">
